(ns audio.governor
  ...
  — not a semantic quality judge, audio.cosci already ran that; this re-checks
  hard invariants audio.judge/audio.cosci have no notion of: license
...
(defn violations
  ...
  audio.loop before this check) -> violation strings. Empty = passes."
  [asset]
  (cond-> []
